...
--
-- Хост: localhost
-- Время создания: Ноя 07 2025 г., 19:39
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Позиции поставок';

--
-- Дамп данных таблицы `supply_items`
--

INSERT INTO `supply_items` (`product_id`, `supply_id`, `quantity`, `production_date`, `expiry_date`) VALUES
(1, 1, 50, '2024-01-15', '2026-01-15'),
(1, 7, 40, '2024-03-12', '2026-03-12'),
(1, 13, 55, '2024-03-10', '2026-03-10'),
(1, 20, 40, '2024-03-12', '2026-03-12'),
(2, 1, 30, '2024-02-10', '2025-08-10'),
(2, 2, 30, '2024-02-10', '2025-08-10'),
(2, 7, 35, '2024-02-18', '2025-08-18'),
(2, 14, 33, '2024-01-28', '2025-07-28'),
(2, 20, 37, '2024-02-25', '2025-08-25'),
(2, 21, 35, '2024-02-18', '2025-08-18'),
(4, 1, 25, '2024-01-20', '2025-07-20'),
(4, 3, 25, '2024-01-20', '2025-07-20'),
(4, 8, 20, '2024-01-14', '2025-07-14'),
(4, 14, 27, '2024-02-18', '2025-08-18'),
(4, 20, 21, '2024-03-22', '2025-09-22'),
(4, 22, 20, '2024-01-14', '2025-07-14'),
(5, 2, 100, '2024-03-05', '2026-03-05'),
(5, 4, 100, '2024-03-05', '2026-03-05'),
(5, 8, 80, '2024-03-20', '2026-03-20'),
(5, 14, 92, '2024-03-12', '2026-03-12'),
(5, 23, 80, '2024-03-20', '2026-03-20'),
(6, 2, 20, '2024-02-15', '2025-08-15'),
(6, 5, 20, '2024-02-15', '2025-08-15'),
(6, 8, 25, '2024-02-22', '2025-08-22'),
(6, 15, 24, '2024-01-22', '2025-07-22'),
(6, 24, 25, '2024-02-22', '2025-08-22'),
(7, 2, 40, '2024-01-25', '2025-07-25'),
(7, 6, 40, '2024-01-25', '2025-07-25'),
(7, 9, 30, '2024-01-30', '2025-07-30'),
(7, 15, 48, '2024-02-28', '2025-08-28'),
(7, 25, 30, '2024-01-30', '2025-07-30'),
(8, 3, 80, '2024-03-01', '2026-03-01'),
(8, 7, 80, '2024-03-01', '2026-03-01'),
(8, 9, 45, '2024-02-05', '2026-02-05'),
(8, 15, 76, '2024-03-05', '2026-03-05'),
(9, 3, 15, '2024-02-20', '2025-11-20'),
(9, 8, 15, '2024-02-20', '2025-11-20'),
(9, 9, 20, '2024-03-01', '2025-09-01'),
(9, 16, 17, '2024-01-18', '2025-10-18'),
(11, 3, 60, '2024-01-30', '2026-01-30'),
(11, 9, 60, '2024-01-30', '2026-01-30'),
(11, 10, 35, '2024-01-25', '2026-01-25'),
(11, 16, 64, '2024-02-22', '2026-02-22'),
(12, 4, 25, '2024-02-25', '2025-08-25'),
(12, 10, 25, '2024-02-25', '2025-08-25'),
(12, 16, 29, '2024-03-15', '2025-09-15'),
(13, 4, 20, '2024-03-10', '2026-03-10'),
(13, 10, 25, '2024-03-05', '2026-03-05'),
(13, 11, 20, '2024-03-10', '2026-03-10'),
(13, 17, 23, '2024-01-25', '2026-01-25'),
(14, 4, 15, '2024-02-28', '2025-11-28'),
(14, 11, 18, '2024-01-20', '2025-10-20'),
(14, 12, 15, '2024-02-28', '2025-11-28'),
(14, 17, 16, '2024-02-12', '2025-11-12'),
(15, 5, 10, '2024-01-18', '2026-01-18'),
(15, 11, 22, '2024-02-10', '2026-02-10'),
(15, 13, 10, '2024-01-18', '2026-01-18'),
(15, 17, 12, '2024-03-08', '2026-03-08'),
(16, 5, 30, '2024-03-08', '2025-09-08'),
(16, 11, 38, '2024-03-15', '2025-09-15'),
(16, 14, 30, '2024-03-08', '2025-09-08'),
(16, 18, 34, '2024-01-30', '2025-09-30'),
(17, 5, 45, '2024-02-12', '2025-08-12'),
(17, 12, 28, '2024-01-30', '2025-07-30'),
(17, 15, 45, '2024-02-12', '2025-08-12'),
(17, 18, 41, '2024-02-20', '2025-08-20'),
(18, 6, 12, '2024-01-22', '2025-10-22'),
(18, 12, 32, '2024-02-25', '2025-11-25'),
(18, 16, 12, '2024-01-22', '2025-10-22'),
(18, 18, 14, '2024-03-01', '2025-10-01'),
(19, 6, 50, '2024-03-15', '2026-03-15'),
(19, 12, 19, '2024-03-08', '2026-03-08'),
(19, 17, 50, '2024-03-15', '2026-03-15'),
(19, 19, 52, '2024-01-15', '2026-01-15'),
(20, 6, 5, '2024-02-05', '2027-02-05'),
(20, 13, 8, '2024-01-15', '2027-01-15'),
(20, 18, 5, '2024-02-05', '2027-02-05'),
(20, 19, 6, '2024-02-08', '2027-02-08'),
(22, 7, 25, '2024-01-28', '2025-07-28'),
(22, 13, 42, '2024-02-20', '2025-08-20'),
(22, 19, 25, '2024-01-28', '2025-07-28');
